...
pub const ARG_BYTE: u8 = 1;
pub const BIN_OP_BYTE: u8 = 2;
pub const CALL_LIB_BYTE: u8 = 3;
pub const CALL_OBJECT: u8 = 4;
pub const CALL_SELF: u8 = 5;
pub const CALL: u8 = 6;
pub const CONSTEXPR: u8 = 7;
pub const DELETE: u8 = 8;
pub const DONE: u8 = 9;
pub const EQU: u8 = 10;
pub const NEQ: u8 = 11;
pub const FAST_REV2: u8 = 12;
pub const IF: u8 = 13;
pub const JUMP: u8 = 14;
pub const JUMP_POP: u8 = 15;
pub const MAKE_BOOL: u8 = 16;
